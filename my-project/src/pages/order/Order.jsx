            ...
            <div className="w-full flex justify-between px-[105px]">
                ...
                <div className="flex-1 mr-[34px]">
                    ...
                    <div className="bg-white w-full p-[19px] mb-[34px]">
                        ...
                        <form action="">
                            ...
                            <div className="mb-[25px]">
                                ...
                                <input type="number" name="phoneNumber" id="phoneNumber" className="w-full h-[38px]" />
                            </div>
                            <div className="mb-[25px]">
                                <label htmlFor="phoneNumber" className="mb-[10px] text-base">
                                    Tỉnh/thành phố
                            ...
                            <div className="mb-[25px]">
                                ...
                                <input type="text" name="detailAdress" id="detailAdress" className="w-full h-[38px]" />
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="bg-white w-full p-[19px] mb-[34px]">
                        ...
                        <div className="text-[14px] mb-5">
                            Mọi giao dịch đều được bảo mật và mã hóa. Thông tin thẻ tín dụng sẽ không bao giỡ được dữ
                            lại.
                        </div>
                        ...
                        <div className="p-[10px] mb-[45px]">
                            ...
                            <div className="flex py-3">
                                <div className="w-[72px] h-[96px]">
                                    <img className='w-full h-full object-cover' src="http://localhost:5173/images/maunu1.webp" alt="" />
                                </div>
                ...
                <div className="w-[390px]">
                    ...
                    <div className="bg-white w-full p-[25px]">
                        ...
                        <button className='btn bg-black text-[20px] text-white rounded-none w-full mb-[25px]'>THANH TOÁN</button>
                    </div>
                </div>
            </div>
        </div>
