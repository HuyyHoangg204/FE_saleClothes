...
function Login() {
    ...
    useEffect(() => {
        ...
        if (accessToken) {
            ...
            let date = new Date();
            if (decodedToken.exp > date.getTime() / 1000) { // Nếu token chưa hết hạn thì navigate về home
                navigate("/");
            }
        }
    }, []);
                    ...
                    <form className="space-y-6" action="#" method="POST">
                        <div>
                            ...
                            <div className="mt-1">
                                ...
                                />
                                {errors.khUserName && (
                                    <div className="text-red-500 text-xs mt-1">{errors.khUserName}</div>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                ...
                                />
                                {errors.khPassWord && (
                                    <div className="text-red-500 text-xs mt-1">{errors.khPassWord}</div>
                                )}
                            </div>
                        </div>
