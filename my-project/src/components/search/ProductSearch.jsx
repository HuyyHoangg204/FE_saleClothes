...
import { getListProductBySearchLetters } from '../../redux/apiRequest';
import icons from '../../assets/icons';
import HomeSectionCard from '../../partials/HomeSectionCard/HomeSectionCard';
import SortProduct from '../SortProduct';
import { useParams } from 'react-router-dom';

function ProductSearch({ dataFilter, title }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await getListProductBySearchLetters(
                    title,
                    currentPage,
                    28,
                    isSort,
        ...
        fetchData();
    }, [currentPage, isSort, dataFilter,query]);
    ...
    return (
        <div className="w-full ml-12">
            <div className="flex justify-between items-center">
                <span className="font-sans font-semibold text-[22px]">KẾT QUẢ TÌM KIẾM THEO '{title}'</span>
                <div
