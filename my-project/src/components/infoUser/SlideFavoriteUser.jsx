...
function SlideFavoriteUser({ handleChange }) {
    ...
    const data = useSelector((state) => state?.product?.getAllFavoriteProduct?.currentAllProduct);
    const loading = useSelector((state) => state?.product?.getAllFavoriteProduct?.isFetching);
