...
import { getBestSellerProduct } from '~/redux/apiRequest';
...
function SectionCarouselBestSeller() {
    ...
    const items = bestSellerProduct?.map((item, index) => (
    ...
    return (
        <div className="relative  lg:px-10 mt-8">
            <div className="flex justify-center">
                <span className="text-3xl font-sans font-medium py-4">Sản phẩm bán chạy nhất</span>
            </div>
