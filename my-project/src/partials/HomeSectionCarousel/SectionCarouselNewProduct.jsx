...
import { getNewProduct } from '~/redux/apiRequest';
import FadeInSection from '../../components/motion/FadeInSection';
import { motion, useInView } from 'framer-motion'; // Import motion từ framer-motion
...
function SectionCaroselNewProduct() {
    ...
    const items = newProduct?.map((item, index) => (
    ...
    return (
        <div className="relative  lg:px-10 mt-8">
            <div className="flex justify-center">
                <span className="text-3xl font-sans font-medium py-4">Sản phẩm mới</span>
            </div>
